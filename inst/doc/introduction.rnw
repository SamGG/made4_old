...
Genes and array projections can also be plotted using \Rfunction{s.var} and \Rfunction{s.groups}.  The function \Rfunction{s.groups} required a class vector (fac), 
...
<<svar3, results=hide>>=
s.groups(estrogen.coa$ord$li, fac=estrogen$ES)
@
...
\begin{center}
<<CIAplot, fig=TRUE>>=
plot(coin, fac=NCI60$classes[,2], clab=0, cpoint=3)
@
