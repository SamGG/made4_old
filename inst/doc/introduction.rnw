...
\Rpackage{made4} requires that \Rpackage{ade4} is installed. \Rpackage{made4} also calls \Rpackage{scatterplot3d}.  These should be installed automatically when you install \Rpackage{made4}. To install \Rpackage{made4}
...
Culhane AC & Thioulouse J. (2006) A multivariate approach to integrating datasets using made4 and ade4.  \textit{R News}, \textbf{6(5):} 54-58. 
