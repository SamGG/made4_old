...
function(df1, df2, fac1, fac2, cia.nf=2, type="nsc", ...){
        ...
        out=switch(type,
               "nsc"= {
                       ...
                       bet1<-between(t.dudi(nsc1), fac1, scannf=FALSE, nf=nf, ...)
                       nsc2<-dudi.nsc(df2, scannf=FALSE, ...)
                       bet2<-between(t.dudi(nsc2), fac2, scannf=FALSE, nf=nf,...)
               ...
               "pca"={
                     ...
                     bet1<-between(pca1, fac1, scannf=FALSE, nf=nf, ...)
                     pca2<-dudi.pca(df2, scannf=FALSE, ...)
                     bet2<-between(pca2, fac2, scannf=FALSE, nf=nf, ...)
                     coin<-coinertia(bet1,bet2, scannf=FALSE, nf=cia.nf, ...)
